...
class MainFunctions():
    def __init__(self):
        super().__init__()
        # Configurando el MAIN WINDOw
        self.ui = UI_MainWindow()   # Cargando widgets desde "src\interfaces\windows\main_window\ui_main.py"
        self.ui.setup_ui(self)

    def set_page(self, page):       # Iniciando la ventana principal de páginas
        self.ui.load_pages.pages.setCurrentWidget(page)

    # Iniciando la columna izquierda de páginas
    ...
    # Retornando dependiendo la visibilidad de la columna izquierda
    ...
    # Retornando dependiendo la visibilidad de la columna derecha
