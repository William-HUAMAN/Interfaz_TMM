...
class Ui_MainPages(object):
    def setupUi(self, MainPages):
        ...
        self.widget = QWidget(self.frame_basics)
        self.widget.setObjectName(u"widget")
        self.widget.setGeometry(QRect(0, 0, 241, 211))
        self.btns_basics = QVBoxLayout(self.widget)
        ...
        self.widget1 = QWidget(self.frame_logo)
        self.widget1.setObjectName(u"widget1")
        self.widget1.setGeometry(QRect(5, 1, 381, 351))
        self.logo_layout = QVBoxLayout(self.widget1)
